  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'resume-preview': '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
      },
      backdropBlur: {
        xs: '2px',
      },
      maxWidth: {
        '8xl': '88rem',
        '9xl': '96rem',
        'resume': '8.5in', // Standard US Letter width
      },
      minHeight: {
        'resume': '11in', // Standard US Letter height
      },
      aspectRatio: {
        'resume': '8.5 / 11', // US Letter aspect ratio
      }
    },
  },
  plugins: [
    ...
    function({ addUtilities, theme }) {
      const newUtilities = {
        ...
        '.bg-gradient-resume': {
          background: `linear-gradient(135deg, ${theme('colors.gray.50')}, ${theme('colors.white')})`,
        },
        '.scrollbar-hide': {
